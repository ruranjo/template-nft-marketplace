    ...
    <Section>
      <div className="title">
            ...
            <p>
                ...
                Praesentium, a. Quaerat esse velit ullam perferendis commodi nostrum quibusdam. Consequatur,
                similique odit? Ullam voluptas quisquam, tempora doloribus iusto dolorum hic quasi!
            </p>
      </div>
      ...
      <div className="marketPlaceTypes">
        {
            marketPlaceType.map((text, index)=>{
              return index%2 === 0 ? <Button text={text} key={index}/> : <Button text={text} key={index} />
            })
        }
      </div>
      ...
      <div className="marketPlaces">
        {
            marketPlaceData.map(({ image, name},index)=>{
              return (
              <div className="marketplace" id={index}>
                <div className="image" >
